  ...
  return (
    <section ref={sectionRef} className="relative flex min-h-screen flex-col overflow-hidden" data-testid="hero-section">
      ...
      <motion.div
        ...
        className="relative z-10 mx-auto flex w-full max-w-[1440px] flex-1 flex-col justify-center px-5 pb-8 pt-20 sm:px-8 sm:pt-24 lg:pt-24"
      >
        <div className="grid items-center gap-10 lg:grid-cols-12">
          <div className="lg:col-span-8">
            ...
            <h1 className="mt-4 font-head text-4xl font-extrabold uppercase leading-[0.95] tracking-tight text-neutral-900 sm:text-5xl lg:text-6xl">
            ...
            <Reveal delay={0.75} className="mt-4 max-w-xl">
            ...
            <Reveal delay={0.9} className="mt-5 flex flex-wrap items-center gap-3 sm:gap-4">
              <button
                type="button"
              ...
              <div style={{ perspective: 900 }}>
                ...
                >
                  <img
                    ...
                    className="h-44 w-full object-cover saturate-[0.75] sm:h-72 lg:h-[min(400px,44vh)]"
                  />
