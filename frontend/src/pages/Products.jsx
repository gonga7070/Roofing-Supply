...
const ProductCard = ({ product, index, expanded, onToggle }) => {
  ...
  return (
    <motion.article
      ...
      className="spotlight-card group relative flex flex-col border border-line bg-white transition-colors duration-300 hover:border-linehi"
    >
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <div className="mt-auto flex gap-3 pt-6">
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 border border-linehi px-4 py-3 font-mono text-[11px] uppercase tracking-[0.2em] text-neutral-700 transition-colors duration-200 hover:border-forge hover:text-forge"
          >
